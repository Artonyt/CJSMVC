...
<head>
    ...
    <title>Panel Administrativo - Gestión de Asignaturas</title>
...
<body>
    ...
    <section class="admin">
        ...
        <div class="crear-asignatura">
            <a href="/dashboard/cjs/views/administrador/asignaturas/create.php" class="button boton-centrado">Crear Nueva Asignatura</a>
        </div>
        <section class="asignaturas" id="section-asignaturas">
            <div class="descripcion-ambiente">
                <p>Listado y Gestión de Asignaturas</p>
            </div>
            <div class="tabla-ambientes tabla-scroll">
                <table class="table table-striped table-dark table_id" border="1" id="tabla-asignaturas">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        if ($result->rowCount() > 0) {
                            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                echo "<td>";
                                $url_update = '/dashboard/cjs/views/administrador/asignaturas/update.php?id=' . $row['ID_asignatura'];
                                echo "<a href='" . htmlspecialchars($url_update) . "' class='boton-modificar'><img src='../../../assets/editar.svg' alt='Editar'></a>";
                                $url_delete = htmlspecialchars($_SERVER["PHP_SELF"]) . "?delete_id=" . $row['ID_asignatura'];
                                echo "<a href='#' class='boton-eliminar' data-id='" . $row['ID_asignatura'] . "'><img src='../../../assets/eliminar.svg' alt='Eliminar'></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='2'>No hay asignaturas registradas</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
